...
public class OneOfTest {
    ...
    @Test
    public void that_oneOf_null_validates() {
        Instance schema = helper.instance("{\"oneOf\":null}");
    ...
    @Test
    public void that_oneOf_empty_invalidates() {
        final Instance schema = helper.instance("{\"oneOf\":[]}");
    ...
    @Test
    public void that_oneOf_not_empty_validates() {
        Instance schema = helper.instance("{\"oneOf\":[{\"type\":\"array\"},{\"type\":\"null\"},{\"type\":\"integer\"},{\"type\":\"string\"}]}");
        ...
        schema = helper.instance("{\"oneOf\":[{\"type\":\"boolean\"},{\"type\":\"number\"},{\"type\":\"object\"}]}");
        ...
        schema = helper.instance("{\"oneOf\":[{\"type\":\"object\"},{\"type\":\"object\"}]}");
        Assert.assertFalse(helper.validate(schema, "{}").isEmpty());
    }
}
