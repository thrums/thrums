...
public class NotTest {
    ...
    @Test
    public void that_not_null_validates() {
        Instance schema = helper.instance("{\"not\":null}");
    ...
    @Test
    public void that_not_empty_invalidates() {
        final Instance schema = helper.instance("{\"not\":[]}");
    ...
    @Test
    public void that_not_not_empty_validates() {
        Instance schema = helper.instance("{\"not\":{\"type\":\"array\"}}");
