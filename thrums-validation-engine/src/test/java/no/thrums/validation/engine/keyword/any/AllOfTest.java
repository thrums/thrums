...
public class AllOfTest {
    ...
    @Test
    public void that_allOf_null_validates() {
        Instance schema = helper.instance("{\"allOf\":null}");
    ...
    @Test
    public void that_allOf_empty_invalidates() {
        final Instance schema = helper.instance("{\"allOf\":[]}");
    ...
    @Test
    public void that_allOf_not_empty_validates() {
        Instance schema = helper.instance("{\"allOf\":[{\"type\":[\"array\", \"null\", \"integer\", \"string\"]}]}");
        ...
        schema = helper.instance("{\"allOf\":[{\"type\":\"boolean\"},{\"type\":\"number\"},{\"type\":\"object\"}]}");
