 ...
 * @since 2015-02-22
 */
public class EngineInstanceLoader implements InstanceLoader {

    private final Mapper mapper;

    public EngineInstanceLoader(Mapper mapper) {
        this.mapper = mapper;
    }
    ...
    public URL getUrl(ClassLoader classLoader, String resource) {
        ...
        if (Objects.isNull(url)) {
            url = EngineInstanceLoader.class.getClassLoader().getResource(resource);
        }
        return url;
    }
